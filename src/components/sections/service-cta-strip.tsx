  ...
  return (
    <section className="bg-blue-600 py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4 text-center sm:flex-row sm:justify-between sm:text-left sm:px-6">
        <div>
          <p className="text-lg font-bold text-white">Ready to fix your screen?</p>
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-2.5 text-sm font-bold text-blue-600 shadow transition hover:bg-blue-50"
          >
            <svg className="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <a
            href={`tel:${SITE.phone}`}
            className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700"
          >
