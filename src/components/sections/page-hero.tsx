      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-7 py-3 text-sm font-bold text-blue-700 shadow-lg transition hover:bg-blue-50"
          >
