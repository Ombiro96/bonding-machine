...
const SERVICE_LINKS = [
  { label: "Phone Screen Repair", href: "/services/phone-screen-repair" },
  { label: "Tablet Screen Repair", href: "/services/tablet-screen-repair" },
    ...
    <footer className="bg-slate-900 text-slate-400">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed">
              Professional LCD screen bonding and repair in Nairobi using OCA bonding technology.
        ...
        <div className="mt-10 border-t border-slate-800 pt-6 text-center text-xs text-slate-500">
          &copy; {new Date().getFullYear()} {SITE.name}. All rights reserved. Nairobi, Kenya.
        </div>
      </div>
    </footer>
  );
