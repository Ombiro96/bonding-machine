  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-3">
      ...
      <a
        ...
        className="group flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg ring-2 ring-white transition hover:scale-110 hover:bg-green-600 active:scale-95"
      >
      ...
      <a
        href={`tel:${SITE.phone}`}
        aria-label="Call us"
        className="group flex h-14 w-14 items-center justify-center rounded-full bg-slate-800 shadow-lg ring-2 ring-white transition hover:scale-110 hover:bg-slate-700 active:scale-95"
      >
